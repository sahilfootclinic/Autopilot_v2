...
export const AI_PORTFOLIOS: AiPortfolio[] = [
  {
    ...
    holdings: [
      { ticker: "TOTO", name: "Toto Ltd", weight: 45, thesis: "Highest-conviction position — synthesised across all tracked portfolios as the dominant consensus name this cycle." },
      { ticker: "NVDA", name: "NVIDIA", weight: 4, thesis: "Most-held AI infrastructure play across every tracked portfolio — hedge funds, politicians and AI models all converge here." },
      ...
      { ticker: "BTC", name: "Bitcoin", weight: 3, thesis: "Macro hedge and digital asset infrastructure play with correlation benefits." },
    ],
  },
  {
    slug: "gpt-portfolio",
