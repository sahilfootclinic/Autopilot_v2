...
export const AI_PORTFOLIOS: AiPortfolio[] = [
  {
    ...
    holdings: [
      ...
      { ticker: "MU", name: "Micron Technology", weight: 5, thesis: "HBM memory pricing cycle upturn and AI server demand acceleration." },
      { ticker: "DRAM", name: "DRAM Semiconductor", weight: 5, thesis: "Memory market consolidation and high-bandwidth memory pricing power." },
      { ticker: "COHR", name: "Coherent Corp", weight: 5, thesis: "Laser and photonics exposure to semiconductor capex and AI infrastructure." },
      { ticker: "BTC", name: "Bitcoin", weight: 4, thesis: "Macro hedge and digital asset infrastructure play with correlation benefits." },
      { ticker: "NXE", name: "Nexgen Energy", weight: 4, thesis: "Nuclear energy renaissance driven by AI data center power demands." },
    ],
  },
  {
    slug: "gpt-portfolio",
