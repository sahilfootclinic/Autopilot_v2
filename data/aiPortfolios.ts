...
export const AI_PORTFOLIOS: AiPortfolio[] = [
  {
    ...
    holdings: [
      { ticker: "TOTOF", name: "Toto Ltd", weight: 45, thesis: "Global market leader in intelligent sanitary ware with dominant Asia-Pacific distribution; premium product mix and commercial real estate recovery create a multi-year compounding runway." },
      { ticker: "MSFT", name: "Microsoft", weight: 4, thesis: "Universal institutional anchor; Azure + Copilot monetisation is the highest-conviction cross-portfolio theme." },
      { ticker: "AAPL", name: "Apple", weight: 4, thesis: "Buffett's largest position and a perennial institutional anchor — services margin and buybacks make it the consensus bedrock." },
      { ticker: "META", name: "Meta Platforms", weight: 4, thesis: "AI-driven ad efficiency surfaced in both hedge fund and AI portfolio analysis; one of the strongest earnings revision stories." },
      { ticker: "GOOGL", name: "Alphabet", weight: 4, thesis: "Search resilience and Gemini monetisation create a re-rating opportunity that multiple tracked portfolios are pricing in." },
      { ticker: "AMZN", name: "Amazon", weight: 4, thesis: "AWS re-acceleration and retail margin expansion appear in nearly every AI model's conviction list." },
      { ticker: "AVGO", name: "Broadcom", weight: 4, thesis: "Custom AI silicon and VMware software mix cited across GPT, Grok and multiple hedge fund 13F positions." },
      { ticker: "LLY", name: "Eli Lilly", weight: 4, thesis: "Incretin franchise with a decade of runway — the lone healthcare mega-cap appearing in both AI and institutional top picks." },
      { ticker: "PLTR", name: "Palantir", weight: 4, thesis: "Unusual consensus between AI portfolios and congressional traders; enterprise AI deployment momentum is well-documented." },
      { ticker: "TSLA", name: "Tesla", weight: 4, thesis: "ARK's highest-conviction bet and Grok's second-largest position — autonomy and energy optionality create asymmetric upside." },
      { ticker: "MU", name: "Micron Technology", weight: 4, thesis: "HBM memory pricing cycle upturn and AI server demand acceleration." },
      { ticker: "DRAM", name: "DRAM Semiconductor", weight: 4, thesis: "Memory market consolidation and high-bandwidth memory pricing power." },
      { ticker: "COHR", name: "Coherent Corp", weight: 4, thesis: "Laser and photonics exposure to semiconductor capex and AI infrastructure." },
      { ticker: "BTC", name: "Bitcoin", weight: 4, thesis: "Macro hedge and digital asset infrastructure play with correlation benefits." },
      { ticker: "NXE", name: "Nexgen Energy", weight: 3, thesis: "Nuclear energy renaissance driven by AI data center power demands." },
    ],
  },
  {
    slug: "gpt-portfolio",
